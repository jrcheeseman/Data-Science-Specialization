...
# Bind rows from each subset to create one data set
data <- rbind(test, train)

# Subset the data to include only the mean and standard deviation for each measurement
...
# Create long skinny version of the variables to be summarized
